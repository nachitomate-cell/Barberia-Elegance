/**
 * seed-latincaribe-membresias.js — Planes de Suscripción en Firestore para THE LATIN CARIBE
 *
 * Crea el documento tenants/latincaribe/configuracion/membresia con los 4 planes base.
 * Clon de seed-aura-membresias.js.
 */
...
const PLANES = [
  ...
  {
    id: 'latincaribe_2_perfilados_barba',
...
async function seedMembresias() {
  console.log('🌱 Inicializando planes de suscripción para The Latin Caribe...');
  ...
  console.log('✅ Documento tenants/latincaribe/configuracion/membresia creado con éxito.');
