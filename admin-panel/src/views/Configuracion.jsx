...
// Section, SettingsGroup, SettingRow, FormField e IosToggle viven en
// components/ui/SettingsPrimitives.jsx (extraídos 2026-07 para compartirlos
// con la vista WhatsApp y futuras). Se importan arriba.
...
export default function Configuracion() {
  ...
  const [opcAvanzadas, setOpcAvanzadas] = useState({
    ...
    // Excepción a la regla de "todo arranca en true": esta es opt-in. Prenderla
  ...
  return (
    <div data-view="configuracion" className="max-w-6xl mx-auto pb-10">
      ...
      <Card Icon={SlidersHorizontal} title="Opciones avanzadas · Agenda del barbero">
        ...
        {/* Exigir caja abierta para completar citas */}
        <div className="border border-slate-700/50 rounded-lg overflow-hidden">
          <div className="flex items-center justify-between gap-3 px-4 py-3 bg-slate-800/40">
            <div className="flex items-center gap-2.5 min-w-0">
              <Wallet size={15} className="text-slate-400 shrink-0" />
              <div className="min-w-0">
                <span className="text-sm font-semibold text-primary block truncate">Exigir caja abierta para completar citas</span>
                <p className="text-[11px] text-slate-500 mt-0.5 leading-relaxed">
                  Impide marcar una cita como Completada mientras no haya una caja abierta del día. Sirve para que no se les olvide abrirla: si se completan citas con la caja cerrada, esos cobros quedan fuera del arqueo. Déjalo apagado si el local no usa el módulo de Caja.
                </p>
              </div>
            </div>
