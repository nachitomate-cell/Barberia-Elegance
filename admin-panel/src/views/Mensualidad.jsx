...
import { CheckCircle2, AlertCircle, XCircle, MessageSquare, ExternalLink, CreditCard } from 'lucide-react';
          ...
          <div className={`bg-slate-900 border rounded-xl p-5 ${cfg.border}`}>
            ...
            {Number(billing?.montoPendiente) > 0 && (
              <div className="border-t border-slate-800 pt-4 mt-4 flex items-end justify-between">
                <div>
                  <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-1">Monto pendiente</p>
