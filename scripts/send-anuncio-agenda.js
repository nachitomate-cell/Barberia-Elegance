...
// scripts/send-anuncio-agenda.js
// ─────────────────────────────────────────────────────────────────
// Replica localmente la Cloud Function broadcastAnuncio para poder
// disparar el push desde el servidor con firebase-admin sin depender
// de la sesión del navegador. Solo para usos autorizados por Ignacio.
//
// Mismo modelo: broadcast_campaigns + subcolección recipients.
// Mismo filtro de audiencia: plataforma !== 'web-admin' && !== 'web-cliente'.
// ─────────────────────────────────────────────────────────────────
...
const TITLE    = 'La agenda no se llena sola.';
const BODY     = 'Revisa tus espacios libres esta semana y ofrécelos a tus clientes frecuentes. Cada corte que cierras hoy suma para el mes.';
const LINK     = '/agenda.html';
const AUDIENCE = 'agenda';
const CREATED_BY = 'ignaciiio.mate@gmail.com (script)';
