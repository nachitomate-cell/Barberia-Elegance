...
(function () {
  ...
  const _tenants = {
    ...
    sionbarberia: {
      categoriasServicio: ['Cortes', 'Barba', 'Combos', 'Color', 'Facial', 'Promos'],
      nombre:          'Studio Atenas',
      nombreCorto:     'Atenas',
      pageTitle:       'Studio Atenas | El cuidado personal es un arte',
      slogan:          'El cuidado personal es un arte.',
      sobreNosotros:   'En Studio Atenas, el cuidado personal es un arte. No solo cortamos; esculpimos tu identidad.<br><br>Fusionamos la elegancia atemporal del clasicismo helénico con la precisión de la barbería moderna. Cada visita es un ritual diseñado para el hombre moderno que valora el detalle y la tradición.<br><br>Experimenta la precisión contemporánea en cortes de vanguardia, la indulgencia de afeitados a navaja con toallas calientes, y la definición duradera de visos personalizados y permanentes suaves. Te invitamos a redescubrir tu mejor versión en un espacio de paz y excelencia.',
      logo:            '/atenas/aten1.png',
      banner:          '/atenas/aten2.png',
      infoBtnLabel:    'Portafolio',
      galeria:         [],
      direccion:       '📍 Viña del Mar',
      horario:         '🕒 Lun–Mié 11–19h · Jue–Vie 11–20h · Sáb 11–18h · Dom cerrado',
      telefono:        '',
      club:            'Club Atenas',
      instagram:       '',
      instagramHandle: '',
