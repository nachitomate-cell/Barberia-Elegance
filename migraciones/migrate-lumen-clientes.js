/**
 * migrate-lumen-clientes.js
 *
 * Migra 808 clientes de D'Jones (lumen) desde el export de AgendaPro.
 *
 ...
 *   node migraciones/migrate-lumen-clientes.js          → DRY RUN (no escribe)
 *   node migraciones/migrate-lumen-clientes.js --commit → escribe a Firestore
 */
...
const INPUT_FILE = path.join(__dirname, 'clientes-lumen-clean.json');
...
async function main() {
  ...
  if (!COMMIT) {
    ...
    console.log('   node migraciones/migrate-lumen-clientes.js --commit\n');
  }
