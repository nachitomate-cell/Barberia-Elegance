/**
 * fix-aura-users-sin-nombre.js
 *
 * Repara usuarios de Aura que quedaron con nombre vacío en tenants/aura/users.
 *
 ...
 *
 * Estrategia:
 *   1. Lee todos los docs de tenants/aura/users donde nombre es '' o falsy.
 ...
 *   node migraciones/fix-aura-users-sin-nombre.js           → DRY RUN
 *   node migraciones/fix-aura-users-sin-nombre.js --commit  → escribe
 */
...
async function main() {
  console.log('\n🔍  Buscando usuarios de Aura sin nombre...');
  console.log(COMMIT
  ...
  if (!COMMIT) {
    ...
    console.log(`    node migraciones/fix-aura-users-sin-nombre.js --commit\n`);
    process.exit(0);
  }
